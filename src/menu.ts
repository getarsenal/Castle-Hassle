...
export function openSettings(profile: Profile, onChange: () => void, onClose: () => void) {
  ...
  root.innerHTML = `<h2>Settings</h2><div class="ovBox">`
    ...
    + `<div class="setRow"><button class="ovClose" id="stWorkshop" style="margin:0 0 8px;width:100%;box-sizing:border-box">🏰 Castle Workshop</button><div class="dblurb" style="margin-top:0">Design your own castles — walls at any angle, towers, gates, the lot. With 5+ saved layouts, campaign sieges use YOUR designs.</div></div>`
